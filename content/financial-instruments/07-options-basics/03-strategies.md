...
Премия стрэддла — рыночная оценка ожидаемого размаха движения. В модуле 9 мы переведём её в число, **подразумеваемую волатильность**. Грубое правило для стрэддла на деньгах: $\text{цена} \approx 0{,}8\,S\,\sigma\sqrt{\tau}$. Здесь $0{,}8 \cdot 100 \cdot \sigma \cdot 0{,}5 = 10{,}1$ даёт $\sigma \approx 25\%$.
