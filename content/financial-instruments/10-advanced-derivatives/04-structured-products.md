...
**Обещание:** через год вернуть 100% вложенного плюс долю роста индекса («коэффициент участия»), если индекс вырос.

**Разложение:** бескупонная облигация на 100 + $k$ коллов на индекс со страйком, равным текущему значению.
...
**Разложение:** цифровые опционы на досрочное погашение, условные на то, что до этого погашения не было, плюс проданный пут «down-and-in» с барьером 70. Формулы нет: зависимость от пути. Оценка — Монте-Карло под $\mathbb{Q}$ (предыдущий урок), 400 000 сценариев:
