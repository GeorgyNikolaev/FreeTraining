...
Своп — две облигации в разных валютах: длинная в одной, короткая в другой. Для компании из примера (получает CNY, платит RUB):

$$
V_{\text{RUB}} = S_t\cdot B_{\text{CNY}} - B_{\text{RUB}},
$$

где $B$ — приведённая стоимость ноги в своей валюте (купоны плюс номинал в конце) по кривой этой валюты, а $S_t$ — текущий курс.
