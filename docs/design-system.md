...
Изумрудный служит и акцентом, и признаком правильного ответа. До проверки
ответов акцент в тесте допустим — это ещё обычный экран. После проверки, в
разборе, зелёный и красный означают только «верно» и «неверно», поэтому там
акцентные элементы не применяются.
